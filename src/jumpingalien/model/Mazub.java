...
public class Mazub extends GameObject {
	...
	/**
	 * Handles a collision of this Mazub with a given Mazub, which in this game can only be the buzam.
	 * 
	 * @param alien
	 * 			The Buzam this Mazub collides with.
	 * @param direction
	 * 			The direction in which this Mazub collides with the given Buzam. 0, 1, 2 and 3 correspond to respectively left, up,
	 * 			right and down.
	 * @pre		The given Buzam exists.
	 * 			| (alien != null)
	 * @effect	If the given buzam isn't dying and both this Mazub and the given buzam are vulnerable,
	 ...
	 * 			|	if (direction != 1) {
	 * 			|		alien.setHitpoints(shark.getHitpoints() - 50)
