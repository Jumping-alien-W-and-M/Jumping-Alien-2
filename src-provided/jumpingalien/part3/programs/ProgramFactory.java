...
import jumpingalien.program.expression.binary.Addition;
import jumpingalien.program.expression.binary.And;
import jumpingalien.program.expression.binary.Division;
import jumpingalien.program.expression.binary.Equals;
import jumpingalien.program.expression.binary.GetTile;
import jumpingalien.program.expression.binary.GreaterThan;
import jumpingalien.program.expression.binary.GreaterThanOrEqualTo;
import jumpingalien.program.expression.binary.IsMoving;
import jumpingalien.program.expression.binary.LessThan;
import jumpingalien.program.expression.binary.LessThanOrEqualTo;
import jumpingalien.program.expression.binary.Multiplication;
import jumpingalien.program.expression.binary.NotEquals;
import jumpingalien.program.expression.binary.Or;
import jumpingalien.program.expression.binary.Subtraction;
import jumpingalien.program.expression.unary.GetHeight;
import jumpingalien.program.expression.unary.GetHitpoints;
import jumpingalien.program.expression.unary.GetWidth;
import jumpingalien.program.expression.unary.GetX;
import jumpingalien.program.expression.unary.GetY;
import jumpingalien.program.expression.unary.IsAir;
import jumpingalien.program.expression.unary.IsDead;
import jumpingalien.program.expression.unary.IsDucking;
import jumpingalien.program.expression.unary.IsJumping;
import jumpingalien.program.expression.unary.IsMagma;
import jumpingalien.program.expression.unary.IsMazub;
import jumpingalien.program.expression.unary.IsPassable;
import jumpingalien.program.expression.unary.IsPlant;
import jumpingalien.program.expression.unary.IsSlime;
import jumpingalien.program.expression.unary.IsTerrain;
import jumpingalien.program.expression.unary.IsWater;
import jumpingalien.program.expression.unary.Not;
import jumpingalien.program.expression.unary.Random;
import jumpingalien.program.expression.unary.SearchObject;
import jumpingalien.program.expression.unary.Sqrt;
